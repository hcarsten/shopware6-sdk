...
> \Swagger\Client\Model\InlineResponse200225 createPromotionSalesChannel($body, $_response)
...
$body = new \Swagger\Client\Model\Body148(); // \Swagger\Client\Model\Body148 | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Body148**](../Model/Body148.md)|  | [optional]
...
$body = new \Swagger\Client\Model\PromotionSalesChannelFlat(); // \Swagger\Client\Model\PromotionSalesChannelFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\PromotionSalesChannelFlat**](../Model/PromotionSalesChannelFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
> \Swagger\Client\Model\InlineResponse200225 getPromotionSalesChannel($id)
...
> \Swagger\Client\Model\InlineResponse200223 getPromotionSalesChannelList($limit, $page, $query)
...
> \Swagger\Client\Model\InlineResponse200225 updatePromotionSalesChannel($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the promotion_sales_channel
$body = new \Swagger\Client\Model\Body149(); // \Swagger\Client\Model\Body149 | Partially update information about a Promotion Sales Channel resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the promotion_sales_channel |
 **body** | [**\Swagger\Client\Model\Body149**](../Model/Body149.md)| Partially update information about a Promotion Sales Channel resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the promotion_sales_channel
$body = new \Swagger\Client\Model\PromotionSalesChannelFlat(); // \Swagger\Client\Model\PromotionSalesChannelFlat | Partially update information about a Promotion Sales Channel resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the promotion_sales_channel |
 **body** | [**\Swagger\Client\Model\PromotionSalesChannelFlat**](../Model/PromotionSalesChannelFlat.md)| Partially update information about a Promotion Sales Channel resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
