...
# **createTheme**
> \Swagger\Client\Model\InlineResponse200303 createTheme($body, $_response)
...
$body = new \Swagger\Client\Model\Body200(); // \Swagger\Client\Model\Body200 | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Body200**](../Model/Body200.md)|  | [optional]
...
$body = new \Swagger\Client\Model\ThemeFlat(); // \Swagger\Client\Model\ThemeFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\ThemeFlat**](../Model/ThemeFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
# **getTheme**
> \Swagger\Client\Model\InlineResponse200303 getTheme($id)
...
# **getThemeList**
> \Swagger\Client\Model\InlineResponse200301 getThemeList($limit, $page, $query)
...
# **updateTheme**
> \Swagger\Client\Model\InlineResponse200303 updateTheme($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the theme
$body = new \Swagger\Client\Model\Body201(); // \Swagger\Client\Model\Body201 | Partially update information about a Theme resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the theme |
 **body** | [**\Swagger\Client\Model\Body201**](../Model/Body201.md)| Partially update information about a Theme resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the theme
$body = new \Swagger\Client\Model\ThemeFlat(); // \Swagger\Client\Model\ThemeFlat | Partially update information about a Theme resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the theme |
 **body** | [**\Swagger\Client\Model\ThemeFlat**](../Model/ThemeFlat.md)| Partially update information about a Theme resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
