...
> \Swagger\Client\Model\InlineResponse200222 createPromotionIndividualCode($body, $_response)
...
$body = new \Swagger\Client\Model\Body146(); // \Swagger\Client\Model\Body146 | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Body146**](../Model/Body146.md)|  | [optional]
...
$body = new \Swagger\Client\Model\PromotionIndividualCodeFlat(); // \Swagger\Client\Model\PromotionIndividualCodeFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\PromotionIndividualCodeFlat**](../Model/PromotionIndividualCodeFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
> \Swagger\Client\Model\InlineResponse200222 getPromotionIndividualCode($id)
...
> \Swagger\Client\Model\InlineResponse200220 getPromotionIndividualCodeList($limit, $page, $query)
...
> \Swagger\Client\Model\InlineResponse200222 updatePromotionIndividualCode($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the promotion_individual_code
$body = new \Swagger\Client\Model\Body147(); // \Swagger\Client\Model\Body147 | Partially update information about a Promotion Individual Code resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the promotion_individual_code |
 **body** | [**\Swagger\Client\Model\Body147**](../Model/Body147.md)| Partially update information about a Promotion Individual Code resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the promotion_individual_code
$body = new \Swagger\Client\Model\PromotionIndividualCodeFlat(); // \Swagger\Client\Model\PromotionIndividualCodeFlat | Partially update information about a Promotion Individual Code resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the promotion_individual_code |
 **body** | [**\Swagger\Client\Model\PromotionIndividualCodeFlat**](../Model/PromotionIndividualCodeFlat.md)| Partially update information about a Promotion Individual Code resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
