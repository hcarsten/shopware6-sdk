...
# **createOrderAddress**
> \Swagger\Client\Model\InlineResponse200150 createOrderAddress($body, $_response)
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Body98**](../Model/Body98.md)|  | [optional]
...
$body = new \Swagger\Client\Model\OrderAddressFlat(); // \Swagger\Client\Model\OrderAddressFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\OrderAddressFlat**](../Model/OrderAddressFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
# **getOrderAddress**
> \Swagger\Client\Model\InlineResponse200150 getOrderAddress($id)
...
# **getOrderAddressList**
> \Swagger\Client\Model\InlineResponse200148 getOrderAddressList($limit, $page, $query)
...
# **updateOrderAddress**
> \Swagger\Client\Model\InlineResponse200150 updateOrderAddress($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the order_address
$body = new \Swagger\Client\Model\Body99(); // \Swagger\Client\Model\Body99 | Partially update information about a Order Address resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the order_address |
 **body** | [**\Swagger\Client\Model\Body99**](../Model/Body99.md)| Partially update information about a Order Address resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the order_address
$body = new \Swagger\Client\Model\OrderAddressFlat(); // \Swagger\Client\Model\OrderAddressFlat | Partially update information about a Order Address resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the order_address |
 **body** | [**\Swagger\Client\Model\OrderAddressFlat**](../Model/OrderAddressFlat.md)| Partially update information about a Order Address resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
