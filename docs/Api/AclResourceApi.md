...
# **createAclResource**
> \Swagger\Client\Model\InlineResponse2003 createAclResource($body, $_response)
...
$body = new \Swagger\Client\Model\AclResourceFlat(); // \Swagger\Client\Model\AclResourceFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\AclResourceFlat**](../Model/AclResourceFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
# **getAclResource**
> \Swagger\Client\Model\InlineResponse2003 getAclResource($id)
...
# **getAclResourceList**
> \Swagger\Client\Model\InlineResponse2001 getAclResourceList($limit, $page, $query)
...
# **updateAclResource**
> \Swagger\Client\Model\InlineResponse2003 updateAclResource($id, $body, $_response)
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the acl_resource |
 **body** | [**\Swagger\Client\Model\Body1**](../Model/Body1.md)| Partially update information about a Acl Resource resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the acl_resource
$body = new \Swagger\Client\Model\AclResourceFlat(); // \Swagger\Client\Model\AclResourceFlat | Partially update information about a Acl Resource resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the acl_resource |
 **body** | [**\Swagger\Client\Model\AclResourceFlat**](../Model/AclResourceFlat.md)| Partially update information about a Acl Resource resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
