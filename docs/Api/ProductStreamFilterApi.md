...
> \Swagger\Client\Model\InlineResponse200207 createProductStreamFilter($body, $_response)
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Body136**](../Model/Body136.md)|  | [optional]
...
$body = new \Swagger\Client\Model\ProductStreamFilterFlat(); // \Swagger\Client\Model\ProductStreamFilterFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\ProductStreamFilterFlat**](../Model/ProductStreamFilterFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
> \Swagger\Client\Model\InlineResponse200207 getProductStreamFilter($id)
...
> \Swagger\Client\Model\InlineResponse200205 getProductStreamFilterList($limit, $page, $query)
...
> \Swagger\Client\Model\InlineResponse200207 updateProductStreamFilter($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the product_stream_filter
$body = new \Swagger\Client\Model\Body137(); // \Swagger\Client\Model\Body137 | Partially update information about a Product Stream Filter resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the product_stream_filter |
 **body** | [**\Swagger\Client\Model\Body137**](../Model/Body137.md)| Partially update information about a Product Stream Filter resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the product_stream_filter
$body = new \Swagger\Client\Model\ProductStreamFilterFlat(); // \Swagger\Client\Model\ProductStreamFilterFlat | Partially update information about a Product Stream Filter resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the product_stream_filter |
 **body** | [**\Swagger\Client\Model\ProductStreamFilterFlat**](../Model/ProductStreamFilterFlat.md)| Partially update information about a Product Stream Filter resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
