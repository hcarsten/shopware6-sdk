...
# **createCmsSection**
> \Swagger\Client\Model\InlineResponse20018 createCmsSection($body, $_response)
...
$body = new \Swagger\Client\Model\CmsSectionFlat(); // \Swagger\Client\Model\CmsSectionFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\CmsSectionFlat**](../Model/CmsSectionFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
# **getCmsSection**
> \Swagger\Client\Model\InlineResponse20018 getCmsSection($id)
...
# **getCmsSectionList**
> \Swagger\Client\Model\InlineResponse20016 getCmsSectionList($limit, $page, $query)
...
# **updateCmsSection**
> \Swagger\Client\Model\InlineResponse20018 updateCmsSection($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the cms_section
$body = new \Swagger\Client\Model\Body11(); // \Swagger\Client\Model\Body11 | Partially update information about a Cms Section resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the cms_section |
 **body** | [**\Swagger\Client\Model\Body11**](../Model/Body11.md)| Partially update information about a Cms Section resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the cms_section
$body = new \Swagger\Client\Model\CmsSectionFlat(); // \Swagger\Client\Model\CmsSectionFlat | Partially update information about a Cms Section resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the cms_section |
 **body** | [**\Swagger\Client\Model\CmsSectionFlat**](../Model/CmsSectionFlat.md)| Partially update information about a Cms Section resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
