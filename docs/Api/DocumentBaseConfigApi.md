...
> \Swagger\Client\Model\InlineResponse20063 createDocumentBaseConfig($body, $_response)
...
$body = new \Swagger\Client\Model\DocumentBaseConfigFlat(); // \Swagger\Client\Model\DocumentBaseConfigFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\DocumentBaseConfigFlat**](../Model/DocumentBaseConfigFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
> \Swagger\Client\Model\InlineResponse20063 getDocumentBaseConfig($id)
...
> \Swagger\Client\Model\InlineResponse20061 getDocumentBaseConfigList($limit, $page, $query)
...
> \Swagger\Client\Model\InlineResponse20063 updateDocumentBaseConfig($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the document_base_config
$body = new \Swagger\Client\Model\Body41(); // \Swagger\Client\Model\Body41 | Partially update information about a Document Base Config resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the document_base_config |
 **body** | [**\Swagger\Client\Model\Body41**](../Model/Body41.md)| Partially update information about a Document Base Config resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the document_base_config
$body = new \Swagger\Client\Model\DocumentBaseConfigFlat(); // \Swagger\Client\Model\DocumentBaseConfigFlat | Partially update information about a Document Base Config resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the document_base_config |
 **body** | [**\Swagger\Client\Model\DocumentBaseConfigFlat**](../Model/DocumentBaseConfigFlat.md)| Partially update information about a Document Base Config resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
