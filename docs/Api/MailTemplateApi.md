...
# **createMailTemplate**
> \Swagger\Client\Model\InlineResponse20099 createMailTemplate($body, $_response)
...
$body = new \Swagger\Client\Model\MailTemplateFlat(); // \Swagger\Client\Model\MailTemplateFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\MailTemplateFlat**](../Model/MailTemplateFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
# **getMailTemplate**
> \Swagger\Client\Model\InlineResponse20099 getMailTemplate($id)
...
# **getMailTemplateList**
> \Swagger\Client\Model\InlineResponse20097 getMailTemplateList($limit, $page, $query)
...
# **updateMailTemplate**
> \Swagger\Client\Model\InlineResponse20099 updateMailTemplate($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the mail_template
$body = new \Swagger\Client\Model\Body65(); // \Swagger\Client\Model\Body65 | Partially update information about a Mail Template resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the mail_template |
 **body** | [**\Swagger\Client\Model\Body65**](../Model/Body65.md)| Partially update information about a Mail Template resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the mail_template
$body = new \Swagger\Client\Model\MailTemplateFlat(); // \Swagger\Client\Model\MailTemplateFlat | Partially update information about a Mail Template resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the mail_template |
 **body** | [**\Swagger\Client\Model\MailTemplateFlat**](../Model/MailTemplateFlat.md)| Partially update information about a Mail Template resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
