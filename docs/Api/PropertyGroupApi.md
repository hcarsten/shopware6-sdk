...
# **createPropertyGroup**
> \Swagger\Client\Model\InlineResponse200231 createPropertyGroup($body, $_response)
...
$body = new \Swagger\Client\Model\Body152(); // \Swagger\Client\Model\Body152 | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Body152**](../Model/Body152.md)|  | [optional]
...
$body = new \Swagger\Client\Model\PropertyGroupFlat(); // \Swagger\Client\Model\PropertyGroupFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\PropertyGroupFlat**](../Model/PropertyGroupFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
# **getPropertyGroup**
> \Swagger\Client\Model\InlineResponse200231 getPropertyGroup($id)
...
> \Swagger\Client\Model\InlineResponse200229 getPropertyGroupList($limit, $page, $query)
...
# **updatePropertyGroup**
> \Swagger\Client\Model\InlineResponse200231 updatePropertyGroup($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the property_group
$body = new \Swagger\Client\Model\Body153(); // \Swagger\Client\Model\Body153 | Partially update information about a Property Group resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the property_group |
 **body** | [**\Swagger\Client\Model\Body153**](../Model/Body153.md)| Partially update information about a Property Group resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the property_group
$body = new \Swagger\Client\Model\PropertyGroupFlat(); // \Swagger\Client\Model\PropertyGroupFlat | Partially update information about a Property Group resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the property_group |
 **body** | [**\Swagger\Client\Model\PropertyGroupFlat**](../Model/PropertyGroupFlat.md)| Partially update information about a Property Group resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
