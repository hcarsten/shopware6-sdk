...
# **createSnippetSet**
> \Swagger\Client\Model\InlineResponse200273 createSnippetSet($body, $_response)
...
$body = new \Swagger\Client\Model\Body180(); // \Swagger\Client\Model\Body180 | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Body180**](../Model/Body180.md)|  | [optional]
...
$body = new \Swagger\Client\Model\SnippetSetFlat(); // \Swagger\Client\Model\SnippetSetFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\SnippetSetFlat**](../Model/SnippetSetFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
# **getSnippetSet**
> \Swagger\Client\Model\InlineResponse200273 getSnippetSet($id)
...
# **getSnippetSetList**
> \Swagger\Client\Model\InlineResponse200271 getSnippetSetList($limit, $page, $query)
...
# **updateSnippetSet**
> \Swagger\Client\Model\InlineResponse200273 updateSnippetSet($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the snippet_set
$body = new \Swagger\Client\Model\Body181(); // \Swagger\Client\Model\Body181 | Partially update information about a Snippet Set resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the snippet_set |
 **body** | [**\Swagger\Client\Model\Body181**](../Model/Body181.md)| Partially update information about a Snippet Set resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the snippet_set
$body = new \Swagger\Client\Model\SnippetSetFlat(); // \Swagger\Client\Model\SnippetSetFlat | Partially update information about a Snippet Set resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the snippet_set |
 **body** | [**\Swagger\Client\Model\SnippetSetFlat**](../Model/SnippetSetFlat.md)| Partially update information about a Snippet Set resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
