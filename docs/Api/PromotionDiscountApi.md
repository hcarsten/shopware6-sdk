...
> \Swagger\Client\Model\InlineResponse200216 createPromotionDiscount($body, $_response)
...
$body = new \Swagger\Client\Model\Body142(); // \Swagger\Client\Model\Body142 | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Body142**](../Model/Body142.md)|  | [optional]
...
$body = new \Swagger\Client\Model\PromotionDiscountFlat(); // \Swagger\Client\Model\PromotionDiscountFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\PromotionDiscountFlat**](../Model/PromotionDiscountFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
> \Swagger\Client\Model\InlineResponse200216 getPromotionDiscount($id)
...
> \Swagger\Client\Model\InlineResponse200214 getPromotionDiscountList($limit, $page, $query)
...
> \Swagger\Client\Model\InlineResponse200216 updatePromotionDiscount($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the promotion_discount
$body = new \Swagger\Client\Model\Body143(); // \Swagger\Client\Model\Body143 | Partially update information about a Promotion Discount resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the promotion_discount |
 **body** | [**\Swagger\Client\Model\Body143**](../Model/Body143.md)| Partially update information about a Promotion Discount resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the promotion_discount
$body = new \Swagger\Client\Model\PromotionDiscountFlat(); // \Swagger\Client\Model\PromotionDiscountFlat | Partially update information about a Promotion Discount resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the promotion_discount |
 **body** | [**\Swagger\Client\Model\PromotionDiscountFlat**](../Model/PromotionDiscountFlat.md)| Partially update information about a Promotion Discount resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
