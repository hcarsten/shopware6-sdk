...
> \Swagger\Client\Model\InlineResponse200105 createMailTemplateType($body, $_response)
...
$body = new \Swagger\Client\Model\MailTemplateTypeFlat(); // \Swagger\Client\Model\MailTemplateTypeFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\MailTemplateTypeFlat**](../Model/MailTemplateTypeFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
# **getMailTemplateType**
> \Swagger\Client\Model\InlineResponse200105 getMailTemplateType($id)
...
> \Swagger\Client\Model\InlineResponse200103 getMailTemplateTypeList($limit, $page, $query)
...
> \Swagger\Client\Model\InlineResponse200105 updateMailTemplateType($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the mail_template_type
$body = new \Swagger\Client\Model\Body69(); // \Swagger\Client\Model\Body69 | Partially update information about a Mail Template Type resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the mail_template_type |
 **body** | [**\Swagger\Client\Model\Body69**](../Model/Body69.md)| Partially update information about a Mail Template Type resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the mail_template_type
$body = new \Swagger\Client\Model\MailTemplateTypeFlat(); // \Swagger\Client\Model\MailTemplateTypeFlat | Partially update information about a Mail Template Type resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the mail_template_type |
 **body** | [**\Swagger\Client\Model\MailTemplateTypeFlat**](../Model/MailTemplateTypeFlat.md)| Partially update information about a Mail Template Type resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
