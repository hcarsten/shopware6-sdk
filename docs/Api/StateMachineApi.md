...
# **createStateMachine**
> \Swagger\Client\Model\InlineResponse200276 createStateMachine($body, $_response)
...
$body = new \Swagger\Client\Model\Body182(); // \Swagger\Client\Model\Body182 | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Body182**](../Model/Body182.md)|  | [optional]
...
$body = new \Swagger\Client\Model\StateMachineFlat(); // \Swagger\Client\Model\StateMachineFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\StateMachineFlat**](../Model/StateMachineFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
# **getStateMachine**
> \Swagger\Client\Model\InlineResponse200276 getStateMachine($id)
...
# **getStateMachineList**
> \Swagger\Client\Model\InlineResponse200274 getStateMachineList($limit, $page, $query)
...
# **updateStateMachine**
> \Swagger\Client\Model\InlineResponse200276 updateStateMachine($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the state_machine
$body = new \Swagger\Client\Model\Body183(); // \Swagger\Client\Model\Body183 | Partially update information about a State Machine resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the state_machine |
 **body** | [**\Swagger\Client\Model\Body183**](../Model/Body183.md)| Partially update information about a State Machine resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the state_machine
$body = new \Swagger\Client\Model\StateMachineFlat(); // \Swagger\Client\Model\StateMachineFlat | Partially update information about a State Machine resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the state_machine |
 **body** | [**\Swagger\Client\Model\StateMachineFlat**](../Model/StateMachineFlat.md)| Partially update information about a State Machine resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
