...
# **createSalutation**
> \Swagger\Client\Model\InlineResponse200252 createSalutation($body, $_response)
...
$body = new \Swagger\Client\Model\Body166(); // \Swagger\Client\Model\Body166 | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Body166**](../Model/Body166.md)|  | [optional]
...
$body = new \Swagger\Client\Model\SalutationFlat(); // \Swagger\Client\Model\SalutationFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\SalutationFlat**](../Model/SalutationFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
# **getSalutation**
> \Swagger\Client\Model\InlineResponse200252 getSalutation($id)
...
# **getSalutationList**
> \Swagger\Client\Model\InlineResponse200250 getSalutationList($limit, $page, $query)
...
# **updateSalutation**
> \Swagger\Client\Model\InlineResponse200252 updateSalutation($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the salutation
$body = new \Swagger\Client\Model\Body167(); // \Swagger\Client\Model\Body167 | Partially update information about a Salutation resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the salutation |
 **body** | [**\Swagger\Client\Model\Body167**](../Model/Body167.md)| Partially update information about a Salutation resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the salutation
$body = new \Swagger\Client\Model\SalutationFlat(); // \Swagger\Client\Model\SalutationFlat | Partially update information about a Salutation resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the salutation |
 **body** | [**\Swagger\Client\Model\SalutationFlat**](../Model/SalutationFlat.md)| Partially update information about a Salutation resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
