...
# **createDeliveryTime**
> \Swagger\Client\Model\InlineResponse20057 createDeliveryTime($body, $_response)
...
$body = new \Swagger\Client\Model\DeliveryTimeFlat(); // \Swagger\Client\Model\DeliveryTimeFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\DeliveryTimeFlat**](../Model/DeliveryTimeFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
# **getDeliveryTime**
> \Swagger\Client\Model\InlineResponse20057 getDeliveryTime($id)
...
# **getDeliveryTimeList**
> \Swagger\Client\Model\InlineResponse20055 getDeliveryTimeList($limit, $page, $query)
...
# **updateDeliveryTime**
> \Swagger\Client\Model\InlineResponse20057 updateDeliveryTime($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the delivery_time
$body = new \Swagger\Client\Model\Body37(); // \Swagger\Client\Model\Body37 | Partially update information about a Delivery Time resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the delivery_time |
 **body** | [**\Swagger\Client\Model\Body37**](../Model/Body37.md)| Partially update information about a Delivery Time resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the delivery_time
$body = new \Swagger\Client\Model\DeliveryTimeFlat(); // \Swagger\Client\Model\DeliveryTimeFlat | Partially update information about a Delivery Time resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the delivery_time |
 **body** | [**\Swagger\Client\Model\DeliveryTimeFlat**](../Model/DeliveryTimeFlat.md)| Partially update information about a Delivery Time resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
