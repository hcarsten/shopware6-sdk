...
# **createSeoUrl**
> \Swagger\Client\Model\InlineResponse200258 createSeoUrl($body, $_response)
...
$body = new \Swagger\Client\Model\Body170(); // \Swagger\Client\Model\Body170 | 
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Body170**](../Model/Body170.md)|  | [optional]
...
$body = new \Swagger\Client\Model\SeoUrlFlat(); // \Swagger\Client\Model\SeoUrlFlat | 
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\SeoUrlFlat**](../Model/SeoUrlFlat.md)|  | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
# **getSeoUrl**
> \Swagger\Client\Model\InlineResponse200258 getSeoUrl($id)
...
# **getSeoUrlList**
> \Swagger\Client\Model\InlineResponse200256 getSeoUrlList($limit, $page, $query)
...
# **updateSeoUrl**
> \Swagger\Client\Model\InlineResponse200258 updateSeoUrl($id, $body, $_response)
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the seo_url
$body = new \Swagger\Client\Model\Body171(); // \Swagger\Client\Model\Body171 | Partially update information about a Seo Url resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the seo_url |
 **body** | [**\Swagger\Client\Model\Body171**](../Model/Body171.md)| Partially update information about a Seo Url resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
...
$id = "38400000-8cf0-11bd-b23e-10b96e4ef00d"; // string | Identifier for the seo_url
$body = new \Swagger\Client\Model\SeoUrlFlat(); // \Swagger\Client\Model\SeoUrlFlat | Partially update information about a Seo Url resource.
$_response = "_response_example"; // string | Data format for response. Empty if none is provided.
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/.md)| Identifier for the seo_url |
 **body** | [**\Swagger\Client\Model\SeoUrlFlat**](../Model/SeoUrlFlat.md)| Partially update information about a Seo Url resource. | [optional]
 **_response** | **string**| Data format for response. Empty if none is provided. | [optional]
